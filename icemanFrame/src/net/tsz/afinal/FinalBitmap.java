	...
	private void doDisplay(View imageView, String uri, BitmapDisplayConfig displayConfig) {
		...
		if (TextUtils.isEmpty(uri) || imageView == null) {
			if(imageView instanceof ImageView){
				if(mConfig.defaultDisplayConfig.getLoadfailBitmap() != null){
					((ImageView)imageView).setImageBitmap(mConfig.defaultDisplayConfig.getLoadfailBitmap());
				}
			}else{
				if(mConfig.defaultDisplayConfig.getLoadfailBitmap() != null){
					imageView.setBackgroundDrawable(new BitmapDrawable(mConfig.defaultDisplayConfig.getLoadfailBitmap()));
				}
			}
			return;
		}
		...
		if (bitmap != null) {
			...
			mConfig.displayer.loadCompletedFromCacheDisplay();
