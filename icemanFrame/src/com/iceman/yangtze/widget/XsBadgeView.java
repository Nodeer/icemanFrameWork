...
/**
 * 
* @ClassName: CYouBadgeView 
* @Description:红色数字气泡提示。来自第三方开源 
* @author yuquan_y	 yuquanyan@cyou-inc.com
* @date 2013-9-9 下午1:37:19
 */
public class XsBadgeView extends TextView {
	...
	public XsBadgeView(Context context) {
		this(context, (AttributeSet) null, android.R.attr.textViewStyle);
	}
	
	public XsBadgeView(Context context, AttributeSet attrs) {
     ...
     */
	public XsBadgeView(Context context, View target) {
     ...
     */
	public XsBadgeView(Context context, TabWidget target, int index) {
		this(context, null, android.R.attr.textViewStyle, target, index);
	}
	
	public XsBadgeView(Context context, AttributeSet attrs, int defStyle) {
		this(context, attrs, defStyle, null, 0);
	}
	
	public XsBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
