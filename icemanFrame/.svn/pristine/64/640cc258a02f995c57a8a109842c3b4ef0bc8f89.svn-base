...
/**
 * 自己重写的Gallery,用于显示照片时使�?
 * 
 * @author rendongwei
 * 
 */
@SuppressWarnings("deprecation")
public class XsPhotoGallery extends Gallery {
	private PhotoImageView imageView;
	private int screenWidth;
	private int screenHeight;

	public XsPhotoGallery(Context context) {
		super(context);
	}

	public XsPhotoGallery(Context context, AttributeSet attrs) {
		super(context, attrs);
		...
		this.setOnTouchListener(new OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				View view = XsPhotoGallery.this.getSelectedView();
	...
	public XsPhotoGallery(Context context, AttributeSet attrs, int defStyle) {
